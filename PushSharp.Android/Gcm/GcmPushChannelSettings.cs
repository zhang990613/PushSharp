...
namespace PushSharp.Android
{
    public class GcmPushChannelSettings : IPushChannelSettings
    {
        ...
        public GcmPushChannelSettings(string senderAuthToken, ProxyInformation ProxyInfo)
            : this(senderAuthToken)
        {
        ...
        public ProxyInformation proxyInformation = new ProxyInformation(false);
